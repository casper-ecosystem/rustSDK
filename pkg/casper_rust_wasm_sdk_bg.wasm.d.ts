...
export function sdk_watchDeploy(a: number, b: number, c: number): number;
export function sdk_waitDeploy(a: number, b: number, c: number, d: number, e: number): number;
export function sdk_wait_deploy(a: number, b: number, c: number, d: number, e: number): number;
export function __wbg_deploywatcher_free(a: number): void;
export function deploywatcher_new(a: number, b: number): number;
...
export function deploywatcher_wait_deploy(a: number, b: number, c: number): number;
export function deploywatcher_start(a: number): void;
...
export function wasm_bindgen__convert__closures__invoke1_mut__h9ffef13b3856ac66(a: number, b: number, c: number): void;
