...
*/
  wait_deploy(deploy_hash: string): Promise<EventParseResult | undefined>;
/**
*/
  start(): void;
}
...
*/
  waitDeploy(events_url: string, deploy_hash: string): Promise<Promise<any>>;
/**
* @param {string} events_url
* @param {string} deploy_hash
* @returns {Promise<EventParseResult>}
*/
  wait_deploy(events_url: string, deploy_hash: string): Promise<EventParseResult>;
}
/**
*/
...
export interface InitOutput {
  ...
  readonly sdk_waitDeploy: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly sdk_wait_deploy: (a: number, b: number, c: number, d: number, e: number) => number;
  ...
  readonly deploywatcher_wait_deploy: (a: number, b: number, c: number) => number;
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h9ffef13b3856ac66: (a: number, b: number, c: number) => void;
